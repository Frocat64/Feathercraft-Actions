...
/**
 * DuckFemaleParented - Matheus
 * Created using Tabula 7.0.0
 */
public class ModelDuckPekin extends ModelBase {
    ...
    public ModelDuckPekin() {
        ...
        this.RightWing1 = new ModelRenderer(this, 46, 20);
        this.RightWing1.setRotationPoint(-2.9F, -2.2F, -5.9F);
        ...
        this.Leg11.setRotationPoint(-2.09F, 0.0F, -1.9F);
        this.Leg11.addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2, 0.0F);
        this.setRotateAngle(Leg11, 0.136659280431156F, -0.0F, 0.0F);
        ...
        this.Body3.setRotationPoint(0.0F, -0.6F, -0.4F);
        this.Body3.addBox(-2.5F, -2.0F, 0.0F, 5, 4, 2, 0.0F);
        ...
        this.Beak2.setRotationPoint(0.0F, -0.5F, -1.5F);
        this.Beak2.addBox(-0.5F, -1.5F, -3.0F, 1, 1, 3, 0.0F);
        this.setRotateAngle(Beak2, 0.2076941809873252F, 0.0F, 0.0F);
        ...
        this.Neck1.setRotationPoint(0.0F, 0.1F, -4.9F);
        this.Neck1.addBox(-1.5F, -1.5F, -4.0F, 3, 3, 4, 0.0F);
        this.setRotateAngle(Neck1, -0.8651597102135892F, 0.0F, 0.0F);
        this.Body4 = new ModelRenderer(this, 22, 0);
        this.Body4.setRotationPoint(0.0F, -1.2F, 1.5F);
        this.Body4.addBox(-2.0F, 0.0F, 0.0F, 4, 1, 3, 0.0F);
        this.setRotateAngle(Body4, 0.4553564018453205F, -0.0F, 0.0F);
        ...
        this.Leg12 = new ModelRenderer(this, 20, 27);
        this.Leg12.setRotationPoint(0.0F, 2.5F, 0.0F);
        ...
        this.Leg22 = new ModelRenderer(this, 20, 27);
        this.Leg22.setRotationPoint(0.0F, 2.5F, 0.0F);
        ...
        this.Leg21.setRotationPoint(2.01F, 0.0F, -1.9F);
        this.Leg21.addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2, 0.0F);
        this.setRotateAngle(Leg21, 0.136659280431156F, -0.0F, 0.0F);
        ...
        this.Body1.setRotationPoint(0.0F, 18.5F, 2.6F);
        this.Body1.addBox(-3.0F, -3.0F, -6.0F, 6, 5, 6, 0.0F);
        this.Neck2 = new ModelRenderer(this, 0, 20);
        this.Neck2.setRotationPoint(0.0F, 0.5F, -3.3F);
        ...
        this.Head.setRotationPoint(0.0F, -1.1F, -3.5F);
        ...
        this.Body5.setRotationPoint(0.0F, 0.9F, 1.4F);
        this.Body5.addBox(-1.5F, -0.5F, 0.0F, 3, 1, 3, 0.0F);
        this.setRotateAngle(Body5, 0.8651597102135892F, -0.0F, 0.0F);
        ...
        this.LeftWing1 = new ModelRenderer(this, 46, 20);
        this.LeftWing1.setRotationPoint(2.9F, -2.2F, -5.9F);
        ...
        this.Beak1.setRotationPoint(0.0F, -1.2F, -1.5F);
        this.Beak1.addBox(-0.5F, -1.5F, -3.0F, 1, 1, 3, 0.0F);
        this.setRotateAngle(Beak1, 0.40142572795869574F, -0.0F, 0.0F);
