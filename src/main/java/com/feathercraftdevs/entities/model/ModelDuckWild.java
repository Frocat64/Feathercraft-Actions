 ...
 */
public class ModelDuckWild extends ModelBase {
    ...
    public ModelDuckWild() {
        this.textureWidth = 64;
        this.textureHeight = 32;
        this.Leg22 = new ModelRenderer(this, 20, 26);
        this.Leg22.setRotationPoint(0.0F, 2.9F, 0.0F);
        ...
        this.Head.setRotationPoint(0.0F, -1.3F, -4.2F);
        this.Head.addBox(-1.5F, -2.8F, -3.0F, 3, 3, 3, 0.0F);
        this.setRotateAngle(Head, 1.605702911834783F, 0.0F, 0.0F);
        this.Body5 = new ModelRenderer(this, 24, 5);
        this.Body5.setRotationPoint(0.0F, 1.0F, 2.5F);
        this.Body5.addBox(-1.5F, -0.5F, 0.0F, 3, 1, 3, 0.0F);
        this.setRotateAngle(Body5, 0.7285004297824331F, -0.0F, 0.0F);
        ...
        this.Leg21.setRotationPoint(2.01F, 0.4F, -1.7F);
        ...
        this.LeftWing1.setRotationPoint(2.9F, -2.0F, -5.9F);
        ...
        this.RightWing1.setRotationPoint(-2.9F, -2.0F, -5.9F);
        ...
        this.Body1.setRotationPoint(0.0F, 17.7F, 2.0F);
        this.Body1.addBox(-3.0F, -2.8F, -6.0F, 6, 5, 6, 0.0F);
        this.Beak2 = new ModelRenderer(this, 0, 9);
        this.Beak2.setRotationPoint(0.1F, -0.1F, -0.23F);
        this.Beak2.addBox(-0.5F, -1.2F, -4.6F, 1, 1, 3, 0.0F);
        this.Leg12 = new ModelRenderer(this, 20, 26);
        this.Leg12.setRotationPoint(0.0F, 2.9F, 0.0F);
        ...
        this.Leg11.setRotationPoint(-2.01F, 0.4F, -1.7F);
        ...
        this.Beak1.setRotationPoint(0.0F, -0.4F, -0.03F);
        ...
        this.Neck1.setRotationPoint(0.0F, 0.0F, -4.8F);
        this.Neck1.addBox(-1.5F, -1.5F, -4.0F, 3, 3, 4, 0.0F);
        this.setRotateAngle(Neck1, -0.8028514559173915F, 0.0F, 0.0F);
        this.Body3 = new ModelRenderer(this, 37, 0);
        this.Body3.setRotationPoint(0.0F, -0.5F, -0.6F);
        this.Body3.addBox(-2.5F, -2.0F, 0.0F, 5, 4, 3, 0.0F);
        this.setRotateAngle(Body3, 0.05235987755982988F, -0.0F, 0.0F);
        this.Body4 = new ModelRenderer(this, 22, 0);
        this.Body4.setRotationPoint(0.0F, -0.5F, 2.8F);
